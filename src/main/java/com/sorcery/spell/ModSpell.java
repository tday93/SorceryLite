...
public class ModSpell
{
    ...
    public static final RegistryObject<Spell> SPELL_RAY_OF_ACID = SPELLS.register("spell_ray_of_acid", () -> new ElementalRaySpell(1, SpellTier.APPRENTICE, SpellSchool.EVOCATION, new AcidElementalComponent(1, 3, 1)));
